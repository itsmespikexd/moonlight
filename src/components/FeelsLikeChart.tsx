    ...
    return (
        <ChartContainer config={chartConfig} className='h-[360px] w-full'>
            <AreaChart accessibilityLayer data={chartData}>
                ...
                <Area dataKey='feels' type='natural' fill='url(#fillFeelsLike)' fillOpacity={0.5} stroke='var(--color-feels)' strokeOpacity={0} />
                <Area dataKey='temp' type='natural' fillOpacity={0} stroke='var(--color-temp)' strokeOpacity={2} activeDot={false} />
